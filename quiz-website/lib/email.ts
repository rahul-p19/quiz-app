...
Congratulations for registering to HELLO-IEEE, our official orientation program specially for you!</p>
      ...
      <p>Please feel free to reply to this email for any queries / clarifications or reach out to us on our official WhatsApp groups.</p><h3>Warm wishes,</h3><h3>IEEE JUSB.</h3>`,
        });
    } catch (error) {
