...
import helloieee from "@/public/assets/helloieee.png";
import logo from "@/public/assets/logo.png";
export function Home() {
  return (
    <div
      id="home"
      className="bg-gradient-to-b from-black via-stone-900 to-indigo-800 flex flex-col items-center justify-center relative w-full h-screen"
    >
      ...
      <div className="text-center text-white flex flex-col gap-4 text-2xl font-light max-w-sm mx-auto my-4">
        <Image
          src={logo}
          alt="Logo"
          width={250}
          height={100}
          className="object-cover px-10 md:px-0"
        />
        <span>presents</span>
      </div>
      <Image
        ...
        width={550}
        height={200}
        className="object-cover mb-4 px-10 md:px-0"
      />
      ...
      <Link href={"/signup"} className="mt-8 md:mt-2">
        {" "}
