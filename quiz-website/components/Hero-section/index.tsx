...
export function Home() {
    return (
        <div id="home" className="h-[40rem] rounded-md bg-[#000] flex flex-col items-center justify-center relative w-full">
            ...
            <h2 className="text-4xl md:text-4xl lg:text-6xl font-semibold max-w-7xl mx-auto text-center mt-6 relative z-20 py-6 bg-clip-text text-transparent bg-gradient-to-b from-neutral-800 via-neutral-700 to-neutral-700 dark:from-neutral-800 dark:via-white dark:to-white">Welcome to <br /> <Cover>IEEE JUSB</Cover></h2>
